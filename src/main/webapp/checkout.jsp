...
<body>
	...
	<div class="page-header">
		...
		<p>Complete your order by providing your details and payment
			information</p>
	</div>
			...
			<div class="checkout-left">
				...
				<div class="card">
					...
					<div class="input-row">
						...
						<div class="input-box">
							<i class="fa-solid fa-phone"></i> <input type="tel" name="phone"
					...
					<div class="input-row">
						<div class="input-box">
							<i class="fa-solid fa-building"></i> <input type="text"
								name="city" placeholder="City" required />
						</div>

						<div class="input-box">
							<i class="fa-solid fa-location-crosshairs"></i> <input
				...
				<div class="card">
					...
					<label class="payment-card"> <input type="radio"
						name="paymentMethod" value="Cash" checked />
					...
					</label> <label class="payment-card"> <input type="radio"
						...
						name="paymentMethod" value="NETBANKING" />
						<div class="radio-circle"></div>
						<div class="payment-icon">
			...
			<div class="checkout-right">
              ...
              %>
					...
					<div class="summary-row">
						<span>Item Subtotal</span> <span>₹<%=String.format("%.2f", itemTotal)%></span>
					</div>
					...
					<div class="summary-row">
						<span>Packaging Fee</span> <span>₹<%=String.format("%.2f", packagingFee)%></span>
					</div>

					<div class="total-box">
						<span>Total Amount</span>
						<h3>
							₹<%=String.format("%.2f", grandTotal)%></h3>
					</div>
					...
					<button type="submit" id="placeOrderBtn" class="place-order"
						<%= (cart == null || cart.getItems().isEmpty()) ? "disabled style='opacity:0.5; cursor:not-allowed;'" : "" %>>
						<i class="fa-solid fa-lock"></i> Place Order
					</button>



					<p class="terms">By placing an order, you agree to our Terms &
						Conditions</p>
				</div>
			</div>
		</form>
